...
public final class Assignment1 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static Assignment1 std = new Assignment1();
    ...
    private static Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = Assignment1.class.getResource(filename);
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(Assignment1.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            Assignment1.save(chooser.getDirectory() + File.separator + chooser.getFile());}}
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = Assignment1.userX(e.getX());
            mouseY = Assignment1.userY(e.getY());
            mousePressed = true; }}
    ...
    public static void main(String[] args) {
        Assignment1.square(.2, .8, .1);
        Assignment1.filledSquare(.8, .8, .2);
        Assignment1.circle(.8, .2, .2);
        Assignment1.setPenColor(Assignment1.BOOK_RED);
        Assignment1.setPenRadius(.02);
        Assignment1.arc(.8, .2, .1, 200, 45);
        Assignment1.setPenRadius();
        Assignment1.setPenColor(Assignment1.BOOK_BLUE);
        double[] x = { .1, .2, .3, .2 };
        double[] y = { .2, .3, .2, .1 };
        Assignment1.filledPolygon(x, y);
        Assignment1.setPenColor(Assignment1.BLACK);
        Assignment1.text(0.2, 0.5, "black text");
        Assignment1.setPenColor(Assignment1.WHITE);
        Assignment1.text(0.8, 0.8, "white text");}}