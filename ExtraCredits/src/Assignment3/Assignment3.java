...
public final class Assignment3 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static Assignment3 std = new Assignment3();
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(Assignment3.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            Assignment3.save(chooser.getDirectory() + File.separator + chooser.getFile());}}
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = Assignment3.userX(e.getX());
            mouseY = Assignment3.userY(e.getY());
            mousePressed = true; }}
    ...
    public static void main(String[] args) {
        Assignment3.square(.2, .8, .1);
        Assignment3.filledSquare(.8, .8, .2);
        Assignment3.circle(.8, .2, .2);
        Assignment3.setPenColor(Assignment3.BOOK_RED);
        Assignment3.setPenRadius(.02);
        Assignment3.arc(.8, .2, .1, 200, 45);
        Assignment3.setPenRadius();
        Assignment3.setPenColor(Assignment3.BOOK_BLUE);
        double[] x = { .1, .2, .3, .2 };
        double[] y = { .2, .3, .2, .1 };
        Assignment3.filledPolygon(x, y);
        Assignment3.setPenColor(Assignment3.BLACK);
        Assignment3.text(0.2, 0.5, "black text");
        Assignment3.setPenColor(Assignment3.WHITE);
        Assignment3.text(0.8, 0.8, "white text");}}