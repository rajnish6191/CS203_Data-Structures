...
public class MyLinkedListG {
  ...
  public MyLinkedListG() {
	  ...
	  String[] studentname = {"Aakash", "Gaurav", "Parth", "Jinesh", "Aakash", "Jigar"};
	  MyList<String> listName = new MyLinkedList<String>(studentname);   

    System.out.println(listName.contains("Aakash"));
